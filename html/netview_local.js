...
*/
	...
	// 
	// .novelの上にカーソルがあるときだけ、bodyにexcitationクラスを追加
	//
	...
	// 
	// 上記は:hoverで実現できるが、iPhoneだと解除のしようがなかった
	//
	document.addEventListener("touchstart", function() {
		document.body.classList.remove("excitation");
	});
	document.addEventListener("touchend", function() {
		document.body.classList.add("excitation");
	});
