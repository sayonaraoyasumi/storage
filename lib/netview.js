...
console.log("font " + jQuery.cookie("font") );
	}
...
console.log("writhing-mode " + mode );
	}
...
console.log("scroll " + jQuery.cookie("scroll") );
	}
...
console.log("cookie; 文字サイズボタン " + jQuery.cookie("font") );
		// ボタンのハイライト
		jQuery(".fontSwitch").removeClass("pick");
