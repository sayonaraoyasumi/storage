...
console.log("DEBUG:スクロール縦 " + scrollposx );
console.log("DEBUG:スクロール縦 " + windowwidth );
console.log("DEBUG:スクロール縦 " + PageMoveRate );
console.log("DEBUG:スクロール縦 " + FlipRange );
console.log("DEBUG:スクロール縦 " + next );
		}else{
